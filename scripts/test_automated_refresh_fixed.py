...
class AutomatedRefreshPerformanceTester:
    ...
    def _print_test_summary(self, report: RefreshTestReport):
        """Print test summary with ASCII-safe characters"""
        print("\n" + "="*80)
        ...
        if report.overall_status == "PASSED":
            print(f"\n[SUCCESS] AUTOMATED REFRESH PERFORMANCE TESTS PASSED")
            print("[SUCCESS] Ancestor resolution performance restored to target SLO")
            print("[SUCCESS] System throughput and cache hit rate maintained")
        else:
            print(f"\n[FAILED] AUTOMATED REFRESH PERFORMANCE TESTS FAILED")
            print("[FAILED] Performance issues detected - immediate investigation required")
...
if __name__ == "__main__":
    # Import timezone for compatibility
