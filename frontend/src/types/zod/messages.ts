 ...
 *
 * Zod Runtime Validation Schemas for WebSocket Messages
 *
 * These schemas validate incoming WebSocket messages before processing.
 * Keep in sync with backend message contracts.
 */
